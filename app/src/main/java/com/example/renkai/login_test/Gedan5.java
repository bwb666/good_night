...
public class Gedan5 extends AppCompatActivity {
    ...
    int cur = 0;
    private int[] resList = new int[]{R.raw.class5_1,R.raw.class5_2,R.raw.class5_3,R.raw.class5_4,R.raw.class5_5,R.raw.class5_6,R.raw.class5_7};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initGedan(); // 初始化歌单
        GedanAdapter adapter = new GedanAdapter(Gedan5.this, R.layout.item_layout, gequList);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i){
                    case 0:
                        ...
                        player = MediaPlayer.create(Gedan5.this,resList[cur]);
...
//        player.setLooping(true);
    ...
    private void initGedan() {
        Gequ song1 = new Gequ("Regulating stubborn insomnia",1);
        gequList.add(song1);
        Gequ song2 = new Gequ("Eliminate anxiety",2);
        gequList.add(song2);
        Gequ song3 = new Gequ("Teach you deep sleep",3);
        gequList.add(song3);
        Gequ song4 = new Gequ("Treating insomnia",4);
        gequList.add(song4);
        Gequ song5 = new Gequ("Improve sleep quality",5);
        gequList.add(song5);
        Gequ song6 = new Gequ("Relax and sleep well",6);
        gequList.add(song6);
        Gequ song7 = new Gequ("Overcome inferiority",7);
        gequList.add(song7);
