...
public class Gedan6 extends AppCompatActivity {
    ...
    int cur = 0;
    private int[] resList = new int[]{R.raw.class6_1,R.raw.class6_2,R.raw.class6_3,R.raw.class6_4,R.raw.class6_5};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initGedan(); // 初始化歌单
        GedanAdapter adapter = new GedanAdapter(Gedan6.this, R.layout.item_layout, gequList);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i){
                    case 0:
                        ...
                        player = MediaPlayer.create(Gedan6.this,resList[cur]);
...
//        player.setLooping(true);
    ...
    private void initGedan() {
        Gequ song1 = new Gequ("Sweeping heart",1);
        gequList.add(song1);
        Gequ song2 = new Gequ("Western lotus",2);
        gequList.add(song2);
        Gequ song3 = new Gequ("Arcadia",3);
        gequList.add(song3);
        Gequ song4 = new Gequ("Cool",4);
        gequList.add(song4);
        Gequ song5 = new Gequ("Lotus Pure Land",5);
        gequList.add(song5);
...
//        intent.setClass(Gedan6.this, Music.class);
