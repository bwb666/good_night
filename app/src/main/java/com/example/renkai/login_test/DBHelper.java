...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String usersInfo_table = "create table usertable" +
                ...
                "password text)";
        String sleep_table = "create table sleeptable" +
                "(id integer primary key autoincrement, riqi text," +
                "sleeptime text)";
        db.execSQL(usersInfo_table);
        db.execSQL(sleep_table);
        Log.i("debug",sleep_table+usersInfo_table);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("alter table sleeptable add column other string");
        Log.i("debug","更新成功了吗");
    }
}
