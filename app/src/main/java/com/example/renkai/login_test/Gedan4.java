...
public class Gedan4 extends AppCompatActivity {
    ...
    int cur = 0;
    private int[] resList = new int[]{R.raw.class4_1,R.raw.class4_2,R.raw.class4_3,R.raw.class4_4,R.raw.class4_5};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initGedan(); // 初始化歌单
        GedanAdapter adapter = new GedanAdapter(Gedan4.this, R.layout.item_layout, gequList);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i){
                    case 0:
                        ...
                        player = MediaPlayer.create(Gedan4.this,resList[cur]);
...
//        player.setLooping(true);
    ...
    private void initGedan() {
        Gequ song1 = new Gequ("As long as ordinary",1);
        gequList.add(song1);
        Gequ song2 = new Gequ("Got windy",2);
        gequList.add(song2);
        Gequ song3 = new Gequ("Unlimited country",3);
        gequList.add(song3);
        Gequ song4 = new Gequ("For the rest of the life",4);
        gequList.add(song4);
        Gequ song5 = new Gequ("Confession night",5);
        gequList.add(song5);
...
//        intent.setClass(Gedan4.this, Music.class);
