...
public class LineChartManager2 {
     ...
     * @return LineData
     */
    public static LineData initSingleLineChart(Context context, LineChart mLineChart, int count, float[] datas,String[] riqis) {
...
//        mLineChart.setMarkerView(mv);
        ...
        lineChart.setBackgroundColor(Color.BLACK); //设置背景颜色
