...
public class Gedan2 extends AppCompatActivity {
    ...
    int cur = 0;
    private int[] resList = new int[]{R.raw.class2_1,R.raw.class2_2,R.raw.class2_3,R.raw.class2_4};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initGedan(); // 初始化歌单
        GedanAdapter adapter = new GedanAdapter(Gedan2.this, R.layout.item_layout, gequList);
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                switch (i){
                    case 0:
                        ...
                        player = MediaPlayer.create(Gedan2.this,resList[cur]);
...
//        player.setLooping(true);
    ...
    private void initGedan() {
        Gequ song1 = new Gequ("Improve neurasthenia",1);
        gequList.add(song1);
        Gequ song2 = new Gequ("Walk quietly under the moon",2);
        gequList.add(song2);
        Gequ song3 = new Gequ("Canoe",3);
        gequList.add(song3);
        Gequ song4 = new Gequ("Breeze blowing the lake",4);
        gequList.add(song4);
...
//        intent.setClass(Gedan2.this, Music.class);
